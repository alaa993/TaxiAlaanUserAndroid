...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setLanguage(SharedHelper.getKey(context, "lang"));
            ...
            materialBuilder.title(R.string.choose_language)
                    ...
                    .itemsCallbackSingleChoice(selectedIndex, new MaterialDialog.ListCallbackSingleChoice() {
                        ...
                        public boolean onSelection(MaterialDialog dialog, View view, int which, CharSequence text) {
                            ...
                            if (selectedLanguage.equalsIgnoreCase("عربى")) {
                            ...
                            handleCheckStatus.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    Log.w("Handler", "Called");
                                    if (helper.isConnectingToInternet()) {
                                        Log.e("lang", "lang"+SharedHelper.getKey(context, "lang"));
                                        setLanguage(SharedHelper.getKey(context, "lang"));
                                        GoToBeginActivity();
    ...
    private void findView(){
        ...
        btn_02_seting = findViewById(R.id.btn_02_seting);

    }

    private  void functionView(){

        btn_02_seting.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void getProfile() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,
                URLHelper.UserProfile /*+ "?device_type=android&device_id=" + device_UDID +
                        "&device_token=" + device_token + "&lang=" +"en"*/, object, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Log.v("GetProfile Splash", response.toString());
                SharedHelper.putKey(context, "id", response.optString("id"));
                SharedHelper.putKey(context, "first_name", response.optString("first_name"));
                SharedHelper.putKey(context, "last_name", response.optString("last_name"));
                SharedHelper.putKey(context, "email", response.optString("email"));
               // SharedHelper.putKey(context, "lang", response.optString("lang"));
    ...
    private void refreshAccessToken() {
        ...
        try {
            ...
            object.put("scope", "");
            Log.d(TAG, "refreshAccessToken: " + object);
